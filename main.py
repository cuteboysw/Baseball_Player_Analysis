...
df=pd.DataFrame(predset_batter, columns=alg_list).to_csv('./result/total_prediction_batter.csv')
df=pd.DataFrame(predset_pitcher, columns=alg_list).to_csv('./result/total_prediction_pitcher.csv')
